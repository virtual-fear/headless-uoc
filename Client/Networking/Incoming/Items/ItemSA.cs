...
public partial class PacketHandlers
{
    ...
    public static event PacketEventHandler<ItemSAEventArgs>? UpdateItemSA;
    public sealed class ItemSAEventArgs : EventArgs
    {
        public NetState State { get; }
        public ItemSAEventArgs(NetState state) => State = state;
    ...
    protected static class ItemSA
    {
        [Obsolete]
        //[PacketHandler(0xF3, length: 24, ingame: true)]
        private static void Update(NetState ns, PacketReader pvSrc)
        {
            ItemSAEventArgs e = new(ns);
