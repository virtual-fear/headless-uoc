...
{
    public static event PacketEventHandler<ContainerContentUpdateEventArgs>? Container_ContentUpdate;
    ...
    protected static class ContainerContentUpdate
    {
        ...
        public static void Update(NetState ns, PacketReader pvSrc)
        {
            ...
            Container_ContentUpdate?.Invoke(e);
        }
    }
}
