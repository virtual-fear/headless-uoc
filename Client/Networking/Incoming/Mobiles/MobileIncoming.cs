...
{
    public static event PacketEventHandler<MobileIncomingEventArgs>? OnMobileIncoming;
    ...
    protected static class MobileIncoming
    {
        ...
        public static void Update(NetState ns, PacketReader pvSrc)
        {
            ...
            //}
            Item.UpdateIncoming(ns, pvSrc);
            OnMobileIncoming?.Invoke(e);
        }
    }
}